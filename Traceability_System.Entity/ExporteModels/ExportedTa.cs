...
namespace Traceability_System.Entity.ExporteModels
{
    ...
    {
        [ExcelKit(Desc = "上传时间", Align = TextAlign.Left)]
        ...
        [ExcelKit(Desc = "箱体识别", Align = TextAlign.Left)]
        public string? CaseDec { get; set; }

        [ExcelKit(Desc = "Rr盖判别", Align = TextAlign.Left)]
        public string? RrCoverDec { get; set; }

        [ExcelKit(Desc = "停车识别", Align = TextAlign.Left)]
        public string? ParkingDec { get; set; }

        [ExcelKit(Desc = "齿轮识别", Align = TextAlign.Left)]
        public string? GearDec { get; set; }

        [ExcelKit(Desc = "变形判别", Align = TextAlign.Left)]
        public string? DefLingDec { get; set; }

        [ExcelKit(Desc = "Hsg识别", Align = TextAlign.Left)]
        public string? HsgDec { get; set; }

        [ExcelKit(Desc = "MG1定子判別", Align = TextAlign.Left)]
        public string? Mg1statorDec { get; set; }

        [ExcelKit(Desc = "MG2定子判別", Align = TextAlign.Left)]
        ...
        [ExcelKit(Desc = "DF箱体", Align = TextAlign.Left)]
        public string? Dfcase { get; set; }

        [ExcelKit(Desc = "油泵", Align = TextAlign.Left)]
        public string? OilPump { get; set; }

        [ExcelKit(Desc = "CASE序列", Width = 19, Align = TextAlign.Left)]
        public string? CaseSerial { get; set; }

        [ExcelKit(Desc = "HSG序列", Width = 19, Align = TextAlign.Left)]
        public string? HsgSerial { get; set; }


        [ExcelKit(Desc = "MG1定子序列", Width = 19, Align = TextAlign.Left)]
        public string? Mg1sserial { get; set; }

        [ExcelKit(Desc = "MG2定子序列", Width = 19, Align = TextAlign.Left)]
        public string? Mg2sserial { get; set; }


        [ExcelKit(Desc = "MG1转子序列", Width = 19, Align = TextAlign.Left)]
        public string? Mg1rserial { get; set; }

        [ExcelKit(Desc = "MG2转子序列", Width = 19, Align = TextAlign.Left)]
        public string? Mg2rserial { get; set; }

        [ExcelKit(Desc = "计数器驱动器序列", Width = 19, Align = TextAlign.Left)]
        public string? CoDriveSerial { get; set; }

        [ExcelKit(Desc = "MG2修正序列", Width = 19, Align = TextAlign.Left)]
        public string? MoDriveSerial { get; set; }


        [ExcelKit(Desc = "受驱动序列", Width = 19, Align = TextAlign.Left)]
        public string? DrivenSerial { get; set; }

        [ExcelKit(Desc = "差速器销序列", Width = 19, Align = TextAlign.Left)]
        public string? DorpinSerial { get; set; }


        [ExcelKit(Desc = "齿圈序列", Width = 19, Align = TextAlign.Left)]
        public string? DfringSerial { get; set; }

        [ExcelKit(Desc = "差速器箱序列", Width = 19, Align = TextAlign.Left)]
        public string? DfcaseSerial { get; set; }

        [ExcelKit(Desc = "Rr盖序列", Width = 19, Align = TextAlign.Left)]
        public string? RrcoverSerial { get; set; }

        [ExcelKit(Desc = "Rr油泵序列", Width = 19, Align = TextAlign.Left)]
        public string? RropSerial { get; set; }

        [ExcelKit(Desc = "轴移载", Align = TextAlign.Left)]
        public string? RotorShaftTrans { get; set; }

        [ExcelKit(Desc = "铁芯移载", Align = TextAlign.Left)]
        public string? RotorCoreTrans { get; set; }

        [ExcelKit(Desc = "加热", Align = TextAlign.Left)]
        public string? RotorHeating { get; set; }

        [ExcelKit(Desc = "轴圧入", Align = TextAlign.Left)]
        public string? RotorShaftPress { get; set; }

        [ExcelKit(Desc = "螺母紧固", Align = TextAlign.Left)]
        public string? RotorNutTight { get; set; }

        [ExcelKit(Desc = "工序履历(异物吸引)", Align = TextAlign.Left)]
        public string? RotorForeignSuction { get; set; }

        [ExcelKit(Desc = "螺母铆接MG1针压入", Align = TextAlign.Left)]
        public string? RotorNutCrimpMg1press { get; set; }

        [ExcelKit(Desc = "旋转变压器压入", Align = TextAlign.Left)]
        public string? RotorResolverPress { get; set; }

        [ExcelKit(Desc = "排斥", Align = TextAlign.Left)]
        public string? RotorReject { get; set; }

        [ExcelKit(Desc = "磁性磁化", Align = TextAlign.Left)]
        public string? RotorMagnetization { get; set; }

        [ExcelKit(Desc = "工序履历(抽样检查)", Align = TextAlign.Left)]
        public string? RotorExtractionInsp { get; set; }

        [ExcelKit(Desc = "工序履历(转子出厂检查综合判定)", Align = TextAlign.Left)]
        ...
        [ExcelKit(Desc = "ID写入", Align = TextAlign.Left)]
        public string? MotorMtrCode { get; set; }

        [ExcelKit(Desc = "序号发生箱子集", Align = TextAlign.Left)]
        public string? MotorSngen { get; set; }

        [ExcelKit(Desc = "Hsg面箱体BrgAM", Align = TextAlign.Left)]
        public string? MotorHsgSrfBrgAm { get; set; }

        [ExcelKit(Desc = "Hsg面定位压入AM", Align = TextAlign.Left)]
        public string? MotorHsgSrfKnockPam { get; set; }

        [ExcelKit(Desc = "冷却管手工作业", Align = TextAlign.Left)]
        public string? MotorCoolPipeMw { get; set; }

        [ExcelKit(Desc = "端子台手工作业", Align = TextAlign.Left)]
        public string? MotorTermBoardMw { get; set; }

        [ExcelKit(Desc = "Rr罩面外BrgAM", Align = TextAlign.Left)]
        public string? MotorRrCoverSrfOutBrgAm { get; set; }

        [ExcelKit(Desc = "Rr罩面定位压入AM", Align = TextAlign.Left)]
        public string? MotorRrCoverSrfKnockPam { get; set; }

        [ExcelKit(Desc = "MG1定子插入AM", Align = TextAlign.Left)]
        public string? MotorMg1statorInsAm { get; set; }

        [ExcelKit(Desc = "MG2定子插入AM", Align = TextAlign.Left)]
        public string? MotorMg2statorInsAm { get; set; }

        [ExcelKit(Desc = "线束释放手工作业", Align = TextAlign.Left)]
        public string? MotorHarnEscMw { get; set; }

        [ExcelKit(Desc = "MG1、2定子紧固AM", Align = TextAlign.Left)]
        public string? MotorMg12statorTightAm { get; set; }

        [ExcelKit(Desc = "热敏电阻手工作业", Align = TextAlign.Left)]
        public string? MotorThermMw { get; set; }

        [ExcelKit(Desc = "冷却管手工作业", Align = TextAlign.Left)]
        public string? MotorCoolPipeMw2 { get; set; }

        [ExcelKit(Desc = "G1、2转子组装", Align = TextAlign.Left)]
        public string? MotorFipgapp { get; set; }

        [ExcelKit(Desc = "FIPG涂布", Align = TextAlign.Left)]
        public string? MotorMg12rotorAssem { get; set; }
        [ExcelKit(Desc = "安装Rr罩子", Align = TextAlign.Left)]

        public string? MotorRrCoverAssem { get; set; }

        [ExcelKit(Desc = "Rr罩子紧固1", Align = TextAlign.Left)]
        public string? MotorRrCoverTight1 { get; set; }

        [ExcelKit(Desc = "Rr罩子紧固2", Align = TextAlign.Left)]
        public string? MotorRrCoverTight2 { get; set; }

        [ExcelKit(Desc = "翻转机", Align = TextAlign.Left)]
        public string? MotorInvMw { get; set; }

        [ExcelKit(Desc = "手动作业１", Align = TextAlign.Left)]
        public string? MotorMw1 { get; set; }

        [ExcelKit(Desc = "手动作业2", Align = TextAlign.Left)]
        public string? MotorMw2 { get; set; }

        [ExcelKit(Desc = "前st", Align = TextAlign.Left)]
        public string? MotorPrevStn { get; set; }

        [ExcelKit(Desc = "手动作业Co0", Align = TextAlign.Left)]
        public string? MotorMwco0 { get; set; }

        [ExcelKit(Desc = "手作業Co1", Align = TextAlign.Left)]
        public string? MotorMwco1 { get; set; }

        [ExcelKit(Desc = "手动作业Co2", Align = TextAlign.Left)]
        public string? MotorMwco2 { get; set; }

        [ExcelKit(Desc = "手动作业Co3", Align = TextAlign.Left)]
        public string? MotorMwco3 { get; set; }

        [ExcelKit(Desc = "拒绝确认", Align = TextAlign.Left)]
        public string? MotorReject { get; set; }

        [ExcelKit(Desc = "备用ID组合", Align = TextAlign.Left)]
        public string? CoverSubIdsetSpare { get; set; }

        [ExcelKit(Desc = "Rr盖组合 DM读取", Align = TextAlign.Left)]
        public string? CoverSubRrCovSetDmread { get; set; }

        [ExcelKit(Desc = "Rr罩子Brg压入设备", Align = TextAlign.Left)]
        ...
        [ExcelKit(Desc = "手动作业３", Align = TextAlign.Left)]
        public string? CoverSubMw3 { get; set; }

        [ExcelKit(Desc = "手动作业４", Align = TextAlign.Left)]
        public string? CoverSubMw4 { get; set; }

        [ExcelKit(Desc = "RR反转设备", Align = TextAlign.Left)]
        public string? CoverSubRrRevEquip { get; set; }

        [ExcelKit(Desc = "防水连接器紧固", Align = TextAlign.Left)]
        public string? CoverSubWaterConnTighten { get; set; }

        [ExcelKit(Desc = "拒绝", Align = TextAlign.Left)]
        public string? CoverSubReject { get; set; }

        [ExcelKit(Desc = "差速器内部组装DF盒读取", Align = TextAlign.Left)]
        public string? DefDfcaseRead { get; set; }

        [ExcelKit(Desc = "DF小齿轮轴组装设备", Align = TextAlign.Left)]
        public string? DefDfpinionShaftEquip { get; set; }

        [ExcelKit(Desc = "差速器动作、位移量测量设备", Align = TextAlign.Left)]
        public string? DefDiffOperMeasureEquip { get; set; }

        [ExcelKit(Desc = "插针式手动作业", Align = TextAlign.Left)]
        public string? DefTweezersMw { get; set; }

        [ExcelKit(Desc = "差速器销铆接", Align = TextAlign.Left)]
        public string? DefDiffPinionPress { get; set; }

        [ExcelKit(Desc = "DM读入", Align = TextAlign.Left)]
        public string? Dmread { get; set; }

        [ExcelKit(Desc = "齿轮压入１", Align = TextAlign.Left)]
        public string? GearPressIn1 { get; set; }

        [ExcelKit(Desc = "齿轮压入２", Align = TextAlign.Left)]
        public string? GearPressIn2 { get; set; }

        [ExcelKit(Desc = "Co从动螺母紧固", Align = TextAlign.Left)]
        public string? Slnffastening { get; set; }

        [ExcelKit(Desc = "Co从动螺母铆接", Align = TextAlign.Left)]
        public string? Slnfriveting { get; set; }

        [ExcelKit(Desc = "差速器Brg压入", Align = TextAlign.Left)]
        public string? DiffBrgPressIn { get; set; }

        [ExcelKit(Desc = "差速器螺栓紧固1", Align = TextAlign.Left)]
        public string? DiffBoltTight1 { get; set; }

        [ExcelKit(Desc = "差速器螺栓紧固2", Align = TextAlign.Left)]
        public string? DiffBoltTight2 { get; set; }

        [ExcelKit(Desc = "反转铆接确认", Align = TextAlign.Left)]
        public string? RevRivetConfirm { get; set; }

        [ExcelKit(Desc = "ダンパー画像", Align = TextAlign.Left)]
        public string? DamperImage { get; set; }

        [ExcelKit(Desc = "リジェクト", Align = TextAlign.Left)]
        public string? Reject { get; set; }

        [ExcelKit(Desc = "ID写入,Hsg集", Align = TextAlign.Left)]
        public string? Idwrite { get; set; }

        [ExcelKit(Desc = "垫片选择", Align = TextAlign.Left)]
        public string? HsgSubShimSel { get; set; }

        [ExcelKit(Desc = "HsgBrg圧入1", Align = TextAlign.Left)]
        public string? HsgBrgPressIn1 { get; set; }

        [ExcelKit(Desc = "HsgBrg圧入2", Align = TextAlign.Left)]
        public string? HsgBrgPressIn2 { get; set; }

        [ExcelKit(Desc = "4种齿轮组装", Align = TextAlign.Left)]
        public string? GearAssembly1 { get; set; }

        [ExcelKit(Desc = "油泵组装", Align = TextAlign.Left)]
        public string? OilPumpAssembly { get; set; }

        [ExcelKit(Desc = "垫片选择", Align = TextAlign.Left)]
        public string? SubShimSel { get; set; }

        [ExcelKit(Desc = "垫片组", Align = TextAlign.Left)]
        public string? ShimSet { get; set; }

        [ExcelKit(Desc = "润滑管组装", Align = TextAlign.Left)]
        public string? LubPipeAssem { get; set; }

        [ExcelKit(Desc = "外壳FIPG涂敷", Align = TextAlign.Left)]
        public string? CaseFipgapp { get; set; }

        [ExcelKit(Desc = "合体组装", Align = TextAlign.Left)]
        public string? AssemJoining1 { get; set; }

        [ExcelKit(Desc = "合体紧固１", Align = TextAlign.Left)]
        public string? AssemTight1 { get; set; }

        [ExcelKit(Desc = "合体紧固２", Align = TextAlign.Left)]
        public string? AssemTight2 { get; set; }

        [ExcelKit(Desc = "排水塞紧固", Align = TextAlign.Left)]
        public string? DrainPlugTight { get; set; }

        [ExcelKit(Desc = "差速器油封压入1", Align = TextAlign.Left)]
        public string? DiffOilsealPress1 { get; set; }

        [ExcelKit(Desc = "差速器油封压入2", Align = TextAlign.Left)]
        public string? DiffOilsealPress2 { get; set; }

        [ExcelKit(Desc = "フィラー締付", Align = TextAlign.Left)]
        public string? FillerTight { get; set; }

        [ExcelKit(Desc = "Assy正立", Align = TextAlign.Left)]
        public string? AssyUpright { get; set; }

        [ExcelKit(Desc = "ID交换", Align = TextAlign.Left)]
        public string? Idexchange { get; set; }

        [ExcelKit(Desc = "油冷却器组装", Align = TextAlign.Left)]
        public string? OilCoolerAssem { get; set; }

        [ExcelKit(Desc = "心轴安装", Align = TextAlign.Left)]
        public string? MandrelAttach { get; set; }

        [ExcelKit(Desc = "前期准备", Align = TextAlign.Left)]
        public string? Preprocessing { get; set; }

        [ExcelKit(Desc = "Assy泄漏测试", Align = TextAlign.Left)]
        public string? AssyLeakTest { get; set; }

        [ExcelKit(Desc = "绝缘", Align = TextAlign.Left)]
        public string? Insulation { get; set; }

        [ExcelKit(Desc = "油注入", Align = TextAlign.Left)]
        public string? OilInjection { get; set; }

        [ExcelKit(Desc = "Assy噪声测试", Align = TextAlign.Left)]
        public string? AssyNoiseTest { get; set; }

        [ExcelKit(Desc = "手动作业①", Align = TextAlign.Left)]
        ...
        [ExcelKit(Desc = "序列刻印", Align = TextAlign.Left)]
        public string? SerialStamping { get; set; }

        [ExcelKit(Desc = "发货步骤1", Align = TextAlign.Left)]
        public string? ShippingPrep1 { get; set; }

        [ExcelKit(Desc = "发货步骤2", Align = TextAlign.Left)]
        public string? ShippingPrep2 { get; set; }

        [ExcelKit(Desc = "外观检查", Align = TextAlign.Left)]
        public string? VisualInsp { get; set; }

        [ExcelKit(Desc = "拒绝", Align = TextAlign.Left)]
        public string? Fipgreject { get; set; }

        [ExcelKit(Desc = "标签发行", Align = TextAlign.Left)]
        ...
        [ExcelKit(Desc = "Hsg侧转向销轴深度t5", Align = TextAlign.Left)]
        public string? ShimHsgt5 { get; set; }

        [ExcelKit(Desc = "Hsg侧马达计数器轴深度t3", Align = TextAlign.Left)]
        public string? ShimHsgt3 { get; set; }

        [ExcelKit(Desc = "Hsg侧输入轴深度t1", Align = TextAlign.Left)]
        public string? ShimHsgt1 { get; set; }

        [ExcelKit(Desc = "壳体侧差速器轴高度t8", Align = TextAlign.Left)]
        public string? ShimShellt8 { get; set; }

        [ExcelKit(Desc = "壳体侧干销轴高度t6", Align = TextAlign.Left)]
        public string? ShimShellt6 { get; set; }

        [ExcelKit(Desc = "箱侧马达计数器轴高度t4", Align = TextAlign.Left)]
        public string? ShimCaset4 { get; set; }

        [ExcelKit(Desc = "箱侧输入轴深度t2", Align = TextAlign.Left)]
        public string? ShimCaset2 { get; set; }

        [ExcelKit(Desc = "垫片滑块（差速器轴）", Align = TextAlign.Left)]
        public string? ShimSlider { get; set; }

        [ExcelKit(Desc = "垫片等级（转向销轴）", Align = TextAlign.Left)]
        public string? ShimGrade { get; set; }

        [ExcelKit(Desc = "垫片等级（马达Co轴)", Align = TextAlign.Left)]
        public string? ShimGradeCo { get; set; }

        [ExcelKit(Desc = "垫片等级（输入轴）", Align = TextAlign.Left)]
        public string? ShimGradeIn { get; set; }

        [ExcelKit(Desc = "垫片实测值（差速器轴）", Align = TextAlign.Left)]
        public string? ShimValueDiff { get; set; }

        [ExcelKit(Desc = "垫片实测值（多拉销轴）", Align = TextAlign.Left)]
        public string? ShimValuePin { get; set; }

        [ExcelKit(Desc = "垫片实测值（马达Co轴）", Align = TextAlign.Left)]
        public string? ShimValueCo { get; set; }

        [ExcelKit(Desc = "垫片实测值（输入轴）", Align = TextAlign.Left)]
        public string? ShimValueIn { get; set; }

        [ExcelKit(Desc = "齿轮直径判定", Align = TextAlign.Left)]
        public string? ShimGear { get; set; }

        [ExcelKit(Desc = "α１（t1 - t2） 修正值", Align = TextAlign.Left)]
        public string? Shimt1t2 { get; set; }

        [ExcelKit(Desc = "α２（t3 - t4） 修正值", Align = TextAlign.Left)]
        public string? Shimt3t4 { get; set; }

        [ExcelKit(Desc = "α３（t5 - t6） 修正值", Align = TextAlign.Left)]
        public string? Shimt5t6 { get; set; }

        [ExcelKit(Desc = "α４（t7 - t8） 修正值", Align = TextAlign.Left)]
        public string? Shimt7t8 { get; set; }

        [ExcelKit(Desc = "t1主值", Align = TextAlign.Left)]
        public string? Shimt1Main { get; set; }

        [ExcelKit(Desc = "t3主值", Align = TextAlign.Left)]
        public string? Shimt3Main { get; set; }

        [ExcelKit(Desc = "t5主值", Align = TextAlign.Left)]
        public string? Shimt5Main { get; set; }

        [ExcelKit(Desc = "t7主值", Align = TextAlign.Left)]
        public string? Shimt7Main { get; set; }

        [ExcelKit(Desc = "t2主值", Align = TextAlign.Left)]
        public string? Shimt2Main { get; set; }

        [ExcelKit(Desc = "t4主值", Align = TextAlign.Left)]
        public string? Shimt4Main { get; set; }

        [ExcelKit(Desc = "t6主值", Align = TextAlign.Left)]
        public string? Shimt6Main { get; set; }

        [ExcelKit(Desc = "t８主值", Align = TextAlign.Left)]
        ...
        [ExcelKit(Desc = "防错防误30计测日時", Align = TextAlign.Left)]
        public string? PokayokeDate30 { get; set; }

        [ExcelKit(Desc = "防错防误31计测日時", Align = TextAlign.Left)]
        public string? PokayokeDate31 { get; set; }

        [ExcelKit(Desc = "外観検査计测日時", Align = TextAlign.Left)]
        public string? InspectionDate { get; set; }

        [ExcelKit(Desc = "防错防误32计测日時", Align = TextAlign.Left)]
