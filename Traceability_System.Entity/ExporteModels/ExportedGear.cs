...
namespace Traceability_System.Entity.ExporteModels
{
    public class ExportedGear
    {
        ...
        [ExcelKit(Desc = "gear齿圈序列", Align = TextAlign.Center)]
        ...
        public string? DgmmeasDate { get; set; }
        ...
        [ExcelKit(Desc = "差速器计测日时", Align = TextAlign.Center)]
        public string? DprmeasDate { get; set; }
